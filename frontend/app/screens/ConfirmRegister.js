				...
				<View style={styles.content}>
					<View>
						<View style={styles.headerContainer}>
							<Text style={styles.header}>Account confirmed</Text>
							<Image style={styles.headerIcon} source={require("./../assets/icons/check-mark.png")} />
						</View>
						<Text style={styles.subheader}>You may now enjoy all the features of the app</Text>
					</View>
					...
					<View>
						...
						<TouchableWithoutFeedback
							...
							<Text style={styles.continueWithoutSignIn}>Continue without Signing In</Text>
						</TouchableWithoutFeedback>
					</View>
				</View>
			</LinearGradient>
